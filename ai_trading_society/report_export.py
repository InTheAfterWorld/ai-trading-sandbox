...
<title>AI Trading Society — Report {_esc(run_id)}</title>
<style>{_CSS}</style>
</head>
<body>
<div class="wrap">
  <h1>📈 AI Trading Society — Simulation Report</h1>
  ...
  <footer>Generated by AI Trading Society · report is self-contained (no external assets)</footer>
</div>
</body>
</html>
"""
